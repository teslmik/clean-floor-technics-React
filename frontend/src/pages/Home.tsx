...
const SwiperBlock = React.lazy(() =>
  import(/* webpackChunkName: "SwiperBlock" */ "../components").then((m) => ({
    default: m.SwiperBlock,
  }))
);
const TabsPromo = React.lazy(() =>
  import(/* webpackChunkName: "TabsPromo" */ "../components").then((m) => ({
    default: m.TabsPromo,
  }))
);
const BlogBlock = React.lazy(() =>
  import(/* webpackChunkName: "BlogBlock" */ "../components").then((m) => ({
    default: m.BlogBlock,
  }))
);
  ...
  return (
    <>
      <Helmet>
        <meta
          property="og:title"
          content="Промислові та комерційні машини Truvox для миття будь-якого типу підлоги"
        />
        <meta property="og:url" content="https://cleanfloor.com.ua/" />
        <meta
          property="og:image"
          content="https://cleanfloor.com.ua/assets/img/logo/logo_insta.png"
        />
      </Helmet>
        ...
        <div className="about__block">
          <div className="about__content content-about">
            ...
            <div className="content-about__text">
              <ReactMarkdown>
                **Truvox International** — провідний постачальник комерційних і
                промислових машин для обслуговування підлог. Компанія заснована
                в Саутгемптоні (Southampton), Великобританія. З дня виробництва
                нашого першого електричного полірувальника на початку 1960-х
                років Truvox успішно розширила як асортимент, так і території
                поширення продукції, в даний час, кількість країн досягає більш
                ніж 70 по всьому світу.
              </ReactMarkdown>
              <ReactMarkdown>
                Truvox пропонує широкий асортимент брендів, що добре
                зарекомендували себе, включаючи полірувальники **Orbis**,
                килимові екстрактори **Hydromist**, пилососи **Valet**,
                підлогонатирачі **Multiwash** і роторні машини **Cimex** з
