...
// import { Status } from "@src/redux/rates/types";
...
//   const [currency, setCurrency] = React.useState<number | null>(null);
...
//     if (ratesItems.rate) {
//       const rateEuro = ratesItems.rate;
...
//                       <Typography>{ratesItems.bankRate ?? "empty"}</Typography>
//                       <Euro />
//                     </Stack>
//                   }
//                 />
