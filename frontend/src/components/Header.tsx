...
import { HeaderMenu, Search } from "../components";
import { useGlobalContext } from "../hooks/useGlobalContext";
import { cartSelector } from "../redux/cart/selectors";

export const Header: React.FC = () => {
  const { items, totalPrice } = useSelector(cartSelector);
  const { setIsOpenCallback, setIsOpenCart, windowWidth, isWebpImg } =
    useGlobalContext();
  ...
  const styleLogo =
    pathname === "/cart" ? { marginRight: "0px", flex: "0 0 auto" } : {};
      ...
      <div className="header__bottom">
        <div className="header__container">
          <div className="header__layout">
            ...
            <div
              className={`header__actions actions ${pathname === "/cart" && "hide"}`}
            >
              ...
              {pathname !== "/cart" &&
                (totalCount > 0 ? (
                  <div
                    className="actions__cart cart-header"
                  ...
                  >
                    ...
                    <div className="cart-header__text">
                      ...
                      <div className="cart-header__price">
